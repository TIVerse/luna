    ...
    pub async fn read(&self) -> Result<String> {
        ...
        #[cfg(feature = "clipboard")]
        {
            let mut ctx: ClipboardContext = ClipboardProvider::new()
                .map_err(|e| LunaError::SystemOperation(format!("Failed to access clipboard: {}", e)))?;
    ...
    pub async fn write(&self, text: &str) -> Result<String> {
        ...
        #[cfg(feature = "clipboard")]
        {
            ...
            ctx.set_contents(text.to_string())
                .map_err(|e| LunaError::SystemOperation(format!("Failed to write clipboard: {}", e)))?;
            
            // Send desktop notification
            self.notify_clipboard_action("Copied to clipboard", text).await;
