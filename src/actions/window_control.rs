    ...
    pub async fn focus_window(&self, app_name: &str) -> Result<String> {
        ...
        #[cfg(target_os = "linux")]
        {
            ...
            let status = Command::new("xdotool")
                ...
                .status()
                .map_err(|e| LunaError::SystemOperation(format!("Failed to focus window: {}", e)))?;
...
if ($p) {{ [Window]::SetForegroundWindow($p.MainWindowHandle) }}"#,
            ...
            if status.success() {
                ...
                Err(LunaError::SystemOperation("Failed to focus window".to_string()))
            }
        }
    ...
    pub async fn maximize_window(&self, app_name: &str) -> Result<String> {
        ...
        #[cfg(target_os = "linux")]
        {
            ...
            if status.success() {
                ...
                Err(LunaError::SystemOperation("wmctrl not found. Install wmctrl".to_string()))
            }
        }
        ...
        #[cfg(not(target_os = "linux"))]
        {
            ...
            Err(LunaError::SystemOperation("Maximize not supported on this platform".to_string()))
        }
    }
    ...
    pub async fn minimize_window(&self, app_name: &str) -> Result<String> {
        ...
        #[cfg(target_os = "linux")]
        {
            ...
            if status.success() {
                ...
                Err(LunaError::SystemOperation("xdotool not found. Install xdotool".to_string()))
            }
        }
        ...
        #[cfg(not(target_os = "linux"))]
        {
            ...
            Err(LunaError::SystemOperation("Minimize not supported on this platform".to_string()))
        }
    }
    ...
    pub async fn move_window(&self, app_name: &str, x: i32, y: i32) -> Result<String> {
        ...
        #[cfg(not(target_os = "linux"))]
        {
            ...
            Err(LunaError::SystemOperation("Move not supported on this platform".to_string()))
        }
    }
    ...
    pub async fn resize_window(&self, app_name: &str, width: u32, height: u32) -> Result<String> {
        ...
        #[cfg(target_os = "linux")]
        {
            let status = Command::new("wmctrl")
                ...
                .status()
                .map_err(|e| LunaError::SystemOperation(format!("Failed to resize window: {}", e)))?;
            
            if status.success() {
                Ok(format!("Resized window {} to {}x{}", app_name, width, height))
            } else {
                Err(LunaError::SystemOperation("wmctrl not found. Install wmctrl".to_string()))
            }
        }
        ...
        #[cfg(not(target_os = "linux"))]
        {
            ...
            Err(LunaError::SystemOperation("Resize not supported on this platform".to_string()))
        }
    }
    ...
    pub async fn close_window(&self, app_name: &str) -> Result<String> {
        ...
        #[cfg(target_os = "linux")]
        {
            let status = Command::new("wmctrl")
                .args(&["-c", app_name])
                .status()
                .map_err(|e| LunaError::SystemOperation(format!("Failed to close window: {}", e)))?;
        ...
        #[cfg(not(target_os = "linux"))]
        {
            ...
            Err(LunaError::SystemOperation("Close not supported on this platform".to_string()))
        }
    }
}
