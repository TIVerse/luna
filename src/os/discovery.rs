...
#[cfg(target_os = "linux")]
use crate::os::linux::{get_flatpak_packages, get_snap_packages};
...
fn categorize_windows_app(name: &str) -> AppCategory {
    ...
    {
        AppCategory::Browser
    } else if name_lower.contains("visual studio")
    ...
    } else if name_lower.contains("media")
...
fn categorize_macos_app(name: &str) -> AppCategory {
    ...
    {
        AppCategory::Browser
    } else if name_lower.contains("xcode")
        || name_lower.contains("intellij")
        || name_lower.contains("pycharm")
    {
        AppCategory::IDE
    } else if name_lower.contains("textedit")
        || name_lower.contains("sublime")
        || name_lower.contains("atom")
        || name_lower.contains("code")
    {
        ...
        || name_lower.contains("spotify")
        || name_lower.contains("vlc")
        || name_lower.contains("quicktime")
    {
        AppCategory::Media
    } else if name_lower.contains("messages")
