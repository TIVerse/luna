...
pub use state::{StateManager, ReferenceType};
pub use unified::{UnifiedContext, ContextEntry, ActionResult, CommandStats};
    ...
    pub fn resolve_text(&self, text: &str) -> String {
        ...
        if text_lower.contains("it") || text_lower.contains("that") {
            ...
            if let Some(file) = self.state.get_last_opened_file() {
                ...
                return text.replace("it", &file_str)
